...
export const SERVICE_LIST_REQUEST ='VENUE_SERVICE_LIST_REQUEST'
export const SERVICE_LIST_SUCCESS ='VENUE_SERVICE_LIST_SUCCESS'
export const SERVICE_LIST_FAIL ='VENUE_SERVICE_LIST_FAIL'
